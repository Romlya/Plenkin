...
const articles = [
  ...
  {
    slug: 'gid-plenka-dlya-shkoly',
    title: 'Гайд: выбор плёнки для школы или детского сада',
    excerpt: 'Какие классы защиты требует МЧС для образовательных учреждений. К4 или Р1А? Документы для приёмки. Сроки монтажа без остановки занятий.',
    date: '2025-06-25',
    readTime: '6 мин',
    category: 'Защита',
  },
  {
    slug: 'gid-broneplenka-bank',
    title: 'Гайд: бронеплёнка для банка или ювелирного салона',
    excerpt: 'Классы Р3А–Р4А. Требования страховых компаний. Сертификаты для приёмки. Почему 200 мкм недостаточно для ювелирного.',
    date: '2025-06-22',
    readTime: '7 мин',
    category: 'Безопасность',
  },
  {
    slug: 'gid-solncezashchita-ofis',
    title: 'Гайд: солнцезащита для офиса и ТЦ',
    excerpt: 'Атермальная vs зеркальная для разных сторон света. Расчёт окупаемости: за сколько сезонов плёнка окупит экономию на кондиционировании.',
    date: '2025-06-18',
    readTime: '5 мин',
    category: 'Солнцезащита',
  },
  {
    slug: 'gid-brendirovanie-ofisa',
    title: 'Гайд: брендирование офиса при переезде',
    excerpt: 'Этапы: замер → дизайн → печать → монтаж. Сроки для типового офиса 100 м². Что входит в «под ключ». Примеры зон.',
    date: '2025-06-12',
    readTime: '5 мин',
    category: 'Дизайн',
  },
  {
    slug: 'gid-plenka-kvartira',
    title: 'Плёнка для квартиры: тонировка балкона, защита от осколков, декор',
    excerpt: 'Что выбрать для балкона, лоджии, кухни, спальни. Атермальная для жары, К4 для защиты от осколков, матовая для санузла. Цены.',
    date: '2025-06-08',
    readTime: '4 мин',
    category: 'Солнцезащита',
  },
